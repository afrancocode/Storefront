...
namespace Agathas.Storefront.Model.Orders
{
	public class OrderBusinessRules
	{
		...
		public static readonly BusinessRule DeliveryAddressRequired = new BusinessRule("DeliveryAddress", "An order must have a valid " + "delivery address.");
		public static readonly BusinessRule ItemsRequired = new BusinessRule("Items", "An order must contain at least one order item.");
		public static readonly BusinessRule ShippingServiceRequired = new BusinessRule("ShippingService", "An order must have a shipping service set.");
	}
}
