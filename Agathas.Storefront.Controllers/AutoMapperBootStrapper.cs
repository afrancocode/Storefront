...
namespace Agathas.Storefront.Controllers
{
	public class AutoMapperBootStrapper
	{
		...
		{
			Mapper.CreateMap<OrderView, OrderPaymentRequest>().ForMember(o => o.Total, ov => ov.ResolveUsing<OrderTotalResolver>()).ForMember(o => o.ShippingCharge, ov => ov.ResolveUsing<ShippingChargeResolver>());
			Mapper.CreateMap<OrderItemView, OrderItemPaymentRequest>().ForMember(o => o.Price, ov => ov.ResolveUsing<ItemPriceResolver>());
		}
	}
